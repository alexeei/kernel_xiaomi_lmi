...
struct sugov_tunables {
	...
	int			ntarget_loads;
#endif /* CONFIG_CPUFREQ_GOV_SCHEDUTILX_TARGET_LOAD */
};
...
#else /* !CONFIG_CPUFREQ_GOV_SCHEDUTILX_TARGET_LOAD */
 ...
 */
unsigned long schedutilX_cpu_util(int cpu, unsigned long util_cfs,
...
struct cpufreq_governor schedutilX_gov;
...
{
	if (old_gov == &schedutilX_gov || policy->governor == &schedutilX_gov) {
		/*
